...
export function ComplianceControlStatus() {
  ...
  useEffect(() => {
    ...
    const data = [
      { label: "已实施", value: 75, color: "#10b981" },
      { label: "部分实施", value: 15, color: "#f59e0b" },
      { label: "未实施", value: 8, color: "#ef4444" },
      { label: "不适用", value: 2, color: "#6b7280" },
    ]
