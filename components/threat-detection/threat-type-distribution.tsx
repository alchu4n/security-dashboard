...
export function ThreatTypeDistribution() {
  ...
  useEffect(() => {
    ...
    const data = [
      { label: "恶意软件", value: 32, color: "#ef4444" },
      { label: "网络钓鱼", value: 24, color: "#f59e0b" },
      { label: "DDoS攻击", value: 18, color: "#3b82f6" },
      { label: "SQL注入", value: 12, color: "#8b5cf6" },
      { label: "暴力破解", value: 8, color: "#10b981" },
