...
export function AssetDistribution() {
  ...
  useEffect(() => {
    ...
    const data = [
      { label: "服务器", value: 28, color: "#3b82f6" },
      { label: "工作站", value: 35, color: "#10b981" },
      { label: "网络设备", value: 18, color: "#f59e0b" },
      { label: "移动设备", value: 12, color: "#8b5cf6" },
      { label: "IoT设备", value: 7, color: "#ef4444" },
    ]
    ...
    const drawPieChart = () => {
      ...
      ctx.fillText("资产类型分布", canvas.width / 2, 10)
